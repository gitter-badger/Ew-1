 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_Await extends Temboo_Choreography
{
    /**
     * Allows your application to perform a "long poll" request that blocks up to a minute or until a change is detected.
     *
     * @param Temboo_Session $session The session that owns this Await Choreo.
     * @return Dropbox_Datastore_Await New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Dropbox/Datastore/Await/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this Await Choreo.
     *
     * @param Dropbox_Datastore_Await_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_Await_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_Await_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Dropbox_Datastore_Await_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Await Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_Await_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Dropbox_Datastore_Await_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the Await Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_Await_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the Await Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_Await_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this Await input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Dropbox_Datastore_Await_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessTokenSecret input for this Await Choreo.
     *
     * @param string $value (required, string) The Access Token Secret retrieved during the OAuth process.
     * @return Dropbox_Datastore_Await_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AccessToken input for this Await Choreo.
     *
     * @param string $value (required, string) The Access Token retrieved during the OAuth process.
     * @return Dropbox_Datastore_Await_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this Await Choreo.
     *
     * @param string $value (required, string) The App Key provided by Dropbox (AKA the OAuth Consumer Key).
     * @return Dropbox_Datastore_Await_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppSecret input for this Await Choreo.
     *
     * @param string $value (required, string) The App Secret provided by Dropbox (AKA the OAuth Consumer Secret).
     * @return Dropbox_Datastore_Await_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Cursors input for this Await Choreo.
     *
     * @param string $value (required, json) A JSON-encoded list of key/value pairs where the key is a datastore handle, and the value is a particular revision. This is required unless specifying Token.
     * @return Dropbox_Datastore_Await_Inputs For method chaining.
     */
    public function setCursors($value)
    {
        return $this->set('Cursors', $value);
    }

    /**
     * Set the value for the ResponseFormat input for this Await Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.
     * @return Dropbox_Datastore_Await_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Token input for this Await Choreo.
     *
     * @param string $value (required, string) A dbase64 string which represents a hash of the datastores list. Token values are returned by the ListDatastores choreo. This is required unless specifying Cursors.
     * @return Dropbox_Datastore_Await_Inputs For method chaining.
     */
...
/**
 * Execution object for the Await Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_Await_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the Await Choreo.
     *
     * @param Temboo_Session $session The session that owns this Await execution.
     * @param Dropbox_Datastore_Await $choreo The choreography object for this execution.
     * @param Dropbox_Datastore_Await_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_Await_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_Await_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Dropbox_Datastore_Await $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this Await execution.
     *
     * @return Dropbox_Datastore_Await_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this Await execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Dropbox_Datastore_Await_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Dropbox_Datastore_Await_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the Await Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_Await_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the Await Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Dropbox_Datastore_Await_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this Await execution.
     *
     * @return string The response from Dropbox. Corresponds to the ResponseFormat input. Defaults to json.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_DeleteDatastore extends Temboo_Choreography
{
    /**
     * Checks the validity of a private datastore ID or creates a new datastore with the given ID.
     *
     * @param Temboo_Session $session The session that owns this DeleteDatastore Choreo.
     * @return Dropbox_Datastore_DeleteDatastore New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Dropbox/Datastore/DeleteDatastore/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this DeleteDatastore Choreo.
     *
     * @param Dropbox_Datastore_DeleteDatastore_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_DeleteDatastore_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_DeleteDatastore_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Dropbox_Datastore_DeleteDatastore_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this DeleteDatastore Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_DeleteDatastore_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Dropbox_Datastore_DeleteDatastore_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the DeleteDatastore Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_DeleteDatastore_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the DeleteDatastore Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_DeleteDatastore_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this DeleteDatastore input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Dropbox_Datastore_DeleteDatastore_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessTokenSecret input for this DeleteDatastore Choreo.
     *
     * @param string $value (required, string) The Access Token Secret retrieved during the OAuth process.
     * @return Dropbox_Datastore_DeleteDatastore_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AccessToken input for this DeleteDatastore Choreo.
     *
     * @param string $value (required, string) The Access Token retrieved during the OAuth process.
     * @return Dropbox_Datastore_DeleteDatastore_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this DeleteDatastore Choreo.
     *
     * @param string $value (required, string) The App Key provided by Dropbox (AKA the OAuth Consumer Key).
     * @return Dropbox_Datastore_DeleteDatastore_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppSecret input for this DeleteDatastore Choreo.
     *
     * @param string $value (required, string) The App Secret provided by Dropbox (AKA the OAuth Consumer Secret).
     * @return Dropbox_Datastore_DeleteDatastore_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Handle input for this DeleteDatastore Choreo.
     *
     * @param string $value (required, string) The handle of an existing datastore to delete.
     * @return Dropbox_Datastore_DeleteDatastore_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this DeleteDatastore Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.
     * @return Dropbox_Datastore_DeleteDatastore_Inputs For method chaining.
     */
...
/**
 * Execution object for the DeleteDatastore Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_DeleteDatastore_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the DeleteDatastore Choreo.
     *
     * @param Temboo_Session $session The session that owns this DeleteDatastore execution.
     * @param Dropbox_Datastore_DeleteDatastore $choreo The choreography object for this execution.
     * @param Dropbox_Datastore_DeleteDatastore_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_DeleteDatastore_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_DeleteDatastore_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Dropbox_Datastore_DeleteDatastore $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this DeleteDatastore execution.
     *
     * @return Dropbox_Datastore_DeleteDatastore_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this DeleteDatastore execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Dropbox_Datastore_DeleteDatastore_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Dropbox_Datastore_DeleteDatastore_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the DeleteDatastore Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_DeleteDatastore_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the DeleteDatastore Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Dropbox_Datastore_DeleteDatastore_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this DeleteDatastore execution.
     *
     * @return string The response from Dropbox. Corresponds to the ResponseFormat input. Defaults to json.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetDeltas extends Temboo_Choreography
{
    /**
     * Returns deltas for a datastore since a given revision.
     *
     * @param Temboo_Session $session The session that owns this GetDeltas Choreo.
     * @return Dropbox_Datastore_GetDeltas New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Dropbox/Datastore/GetDeltas/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this GetDeltas Choreo.
     *
     * @param Dropbox_Datastore_GetDeltas_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_GetDeltas_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_GetDeltas_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Dropbox_Datastore_GetDeltas_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetDeltas Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_GetDeltas_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Dropbox_Datastore_GetDeltas_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the GetDeltas Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetDeltas_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the GetDeltas Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_GetDeltas_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this GetDeltas input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Dropbox_Datastore_GetDeltas_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessTokenSecret input for this GetDeltas Choreo.
     *
     * @param string $value (required, string) The Access Token Secret retrieved during the OAuth process.
     * @return Dropbox_Datastore_GetDeltas_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AccessToken input for this GetDeltas Choreo.
     *
     * @param string $value (required, string) The Access Token retrieved during the OAuth process.
     * @return Dropbox_Datastore_GetDeltas_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetDeltas Choreo.
     *
     * @param string $value (required, string) The App Key provided by Dropbox (AKA the OAuth Consumer Key).
     * @return Dropbox_Datastore_GetDeltas_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppSecret input for this GetDeltas Choreo.
     *
     * @param string $value (required, string) The App Secret provided by Dropbox (AKA the OAuth Consumer Secret).
     * @return Dropbox_Datastore_GetDeltas_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Handle input for this GetDeltas Choreo.
     *
     * @param string $value (required, string) The handle of an existing datastore.
     * @return Dropbox_Datastore_GetDeltas_Inputs For method chaining.
     */
    public function setHandle($value)
    {
    ...
    /**
     * Set the value for the ResponseFormat input for this GetDeltas Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.
     * @return Dropbox_Datastore_GetDeltas_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Revision input for this GetDeltas Choreo.
     *
     * @param string $value (required, string) The revision from which to start.
     * @return Dropbox_Datastore_GetDeltas_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetDeltas Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetDeltas_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the GetDeltas Choreo.
     *
     * @param Temboo_Session $session The session that owns this GetDeltas execution.
     * @param Dropbox_Datastore_GetDeltas $choreo The choreography object for this execution.
     * @param Dropbox_Datastore_GetDeltas_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_GetDeltas_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_GetDeltas_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Dropbox_Datastore_GetDeltas $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this GetDeltas execution.
     *
     * @return Dropbox_Datastore_GetDeltas_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this GetDeltas execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Dropbox_Datastore_GetDeltas_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Dropbox_Datastore_GetDeltas_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the GetDeltas Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetDeltas_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the GetDeltas Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Dropbox_Datastore_GetDeltas_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this GetDeltas execution.
     *
     * @return string The response from Dropbox. Corresponds to the ResponseFormat input. Defaults to json.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetOrCreateDatastore extends Temboo_Choreography
{
    /**
     * Checks the validity of a private datastore ID or creates a new datastore with the given ID.
     *
     * @param Temboo_Session $session The session that owns this GetOrCreateDatastore Choreo.
     * @return Dropbox_Datastore_GetOrCreateDatastore New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Dropbox/Datastore/GetOrCreateDatastore/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this GetOrCreateDatastore Choreo.
     *
     * @param Dropbox_Datastore_GetOrCreateDatastore_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_GetOrCreateDatastore_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Dropbox_Datastore_GetOrCreateDatastore_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this GetOrCreateDatastore Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Dropbox_Datastore_GetOrCreateDatastore_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the GetOrCreateDatastore Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetOrCreateDatastore_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the GetOrCreateDatastore Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this GetOrCreateDatastore input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessTokenSecret input for this GetOrCreateDatastore Choreo.
     *
     * @param string $value (required, string) The Access Token Secret retrieved during the OAuth process.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AccessToken input for this GetOrCreateDatastore Choreo.
     *
     * @param string $value (required, string) The Access Token retrieved during the OAuth process.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetOrCreateDatastore Choreo.
     *
     * @param string $value (required, string) The App Key provided by Dropbox (AKA the OAuth Consumer Key).
     * @return Dropbox_Datastore_GetOrCreateDatastore_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppSecret input for this GetOrCreateDatastore Choreo.
     *
     * @param string $value (required, string) The App Secret provided by Dropbox (AKA the OAuth Consumer Secret).
     * @return Dropbox_Datastore_GetOrCreateDatastore_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the DatastoreID input for this GetOrCreateDatastore Choreo.
     *
     * @param string $value (required, string) The private ID for a datastore to create or to verify.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Inputs For method chaining.
     */
    public function setDatastoreID($value)
    {
        return $this->set('DatastoreID', $value);
    }

    /**
     * Set the value for the ResponseFormat input for this GetOrCreateDatastore Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Inputs For method chaining.
     */
...
/**
 * Execution object for the GetOrCreateDatastore Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetOrCreateDatastore_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the GetOrCreateDatastore Choreo.
     *
     * @param Temboo_Session $session The session that owns this GetOrCreateDatastore execution.
     * @param Dropbox_Datastore_GetOrCreateDatastore $choreo The choreography object for this execution.
     * @param Dropbox_Datastore_GetOrCreateDatastore_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_GetOrCreateDatastore_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Dropbox_Datastore_GetOrCreateDatastore $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this GetOrCreateDatastore execution.
     *
     * @return Dropbox_Datastore_GetOrCreateDatastore_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this GetOrCreateDatastore execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Dropbox_Datastore_GetOrCreateDatastore_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the GetOrCreateDatastore Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetOrCreateDatastore_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the GetOrCreateDatastore Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Dropbox_Datastore_GetOrCreateDatastore_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this GetOrCreateDatastore execution.
     *
     * @return string The response from Dropbox. Corresponds to the ResponseFormat input. Defaults to json.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetSnapshot extends Temboo_Choreography
{
    /**
     * Returns a full snapshot of a datastore.
     *
     * @param Temboo_Session $session The session that owns this GetSnapshot Choreo.
     * @return Dropbox_Datastore_GetSnapshot New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Dropbox/Datastore/GetSnapshot/');
    }
     ...
     *
     * @param Dropbox_Datastore_GetSnapshot_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_GetSnapshot_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_GetSnapshot_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Dropbox_Datastore_GetSnapshot_Execution($this->session, $this, $inputs, $async, $store_results);
    }
     ...
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_GetSnapshot_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Dropbox_Datastore_GetSnapshot_Inputs($inputs);
    }
}
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetSnapshot_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the GetSnapshot Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_GetSnapshot_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
     ...
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Dropbox_Datastore_GetSnapshot_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessTokenSecret input for this GetSnapshot Choreo.
     *
     * @param string $value (required, string) The Access Token Secret retrieved during the OAuth process.
     * @return Dropbox_Datastore_GetSnapshot_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this GetSnapshot Choreo.
     *
     * @param string $value (required, string) The App Key provided by Dropbox (AKA the OAuth Consumer Key).
     * @return Dropbox_Datastore_GetSnapshot_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppSecret input for this GetSnapshot Choreo.
     *
     * @param string $value (required, string) The App Secret provided by Dropbox (AKA the OAuth Consumer Secret).
     * @return Dropbox_Datastore_GetSnapshot_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Handle input for this GetSnapshot Choreo.
     *
     * @param string $value (required, string) The handle of an existing datastore.
     * @return Dropbox_Datastore_GetSnapshot_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this GetSnapshot Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.
     * @return Dropbox_Datastore_GetSnapshot_Inputs For method chaining.
     */
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetSnapshot_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the GetSnapshot Choreo.
     *
     * @param Temboo_Session $session The session that owns this GetSnapshot execution.
     * @param Dropbox_Datastore_GetSnapshot $choreo The choreography object for this execution.
     * @param Dropbox_Datastore_GetSnapshot_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_GetSnapshot_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_GetSnapshot_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Dropbox_Datastore_GetSnapshot $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     *
     * @return Dropbox_Datastore_GetSnapshot_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    protected function wrapResults($outputs)
    {
        return new Dropbox_Datastore_GetSnapshot_Results($outputs);
    }
}
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_GetSnapshot_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the GetSnapshot Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Dropbox_Datastore_GetSnapshot_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_InsertRecord extends Temboo_Choreography
{
    /**
     * Inserts a record into a datastore table.
     *
     * @param Temboo_Session $session The session that owns this InsertRecord Choreo.
     * @return Dropbox_Datastore_InsertRecord New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Dropbox/Datastore/InsertRecord/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this InsertRecord Choreo.
     *
     * @param Dropbox_Datastore_InsertRecord_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_InsertRecord_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_InsertRecord_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Dropbox_Datastore_InsertRecord_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this InsertRecord Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_InsertRecord_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Dropbox_Datastore_InsertRecord_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the InsertRecord Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_InsertRecord_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the InsertRecord Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_InsertRecord_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this InsertRecord input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessTokenSecret input for this InsertRecord Choreo.
     *
     * @param string $value (required, string) The Access Token Secret retrieved during the OAuth process.
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AccessToken input for this InsertRecord Choreo.
     *
     * @param string $value (required, string) The Access Token retrieved during the OAuth process.
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this InsertRecord Choreo.
     *
     * @param string $value (required, string) The App Key provided by Dropbox (AKA the OAuth Consumer Key).
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppSecret input for this InsertRecord Choreo.
     *
     * @param string $value (required, string) The App Secret provided by Dropbox (AKA the OAuth Consumer Secret).
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Data input for this InsertRecord Choreo.
     *
     * @param string $value (required, json) A JSON-encoded list of name/value pairs to insert into the table.
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Handle input for this InsertRecord Choreo.
     *
     * @param string $value (required, string) The handle of an existing datastore.
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this InsertRecord Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Revision input for this InsertRecord Choreo.
     *
     * @param string $value (conditional, string) The revision to which to apply the delta. If not provided, the Choreo will perform a lookup for the latest revision number.
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    public function setRevision($value)
    {
    ...
    /**
     * Set the value for the RowID input for this InsertRecord Choreo.
     *
     * @param string $value (conditional, string) The row identifier. If not provided, a randomly generated GUID will be inserted for this value.
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Table input for this InsertRecord Choreo.
     *
     * @param string $value (required, string) The name of the datastore table.
     * @return Dropbox_Datastore_InsertRecord_Inputs For method chaining.
     */
...
/**
 * Execution object for the InsertRecord Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_InsertRecord_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the InsertRecord Choreo.
     *
     * @param Temboo_Session $session The session that owns this InsertRecord execution.
     * @param Dropbox_Datastore_InsertRecord $choreo The choreography object for this execution.
     * @param Dropbox_Datastore_InsertRecord_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_InsertRecord_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_InsertRecord_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Dropbox_Datastore_InsertRecord $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this InsertRecord execution.
     *
     * @return Dropbox_Datastore_InsertRecord_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this InsertRecord execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Dropbox_Datastore_InsertRecord_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Dropbox_Datastore_InsertRecord_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the InsertRecord Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_InsertRecord_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the InsertRecord Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Dropbox_Datastore_InsertRecord_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this InsertRecord execution.
     *
     * @return string The response from Dropbox. Corresponds to the ResponseFormat input. Defaults to json.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_ListDatastores extends Temboo_Choreography
{
    /**
     * Retrieves a list of all datastores for the current user.
     *
     * @param Temboo_Session $session The session that owns this ListDatastores Choreo.
     * @return Dropbox_Datastore_ListDatastores New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Dropbox/Datastore/ListDatastores/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this ListDatastores Choreo.
     *
     * @param Dropbox_Datastore_ListDatastores_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_ListDatastores_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_ListDatastores_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Dropbox_Datastore_ListDatastores_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this ListDatastores Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_ListDatastores_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Dropbox_Datastore_ListDatastores_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the ListDatastores Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_ListDatastores_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the ListDatastores Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_ListDatastores_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this ListDatastores input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Dropbox_Datastore_ListDatastores_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessTokenSecret input for this ListDatastores Choreo.
     *
     * @param string $value (required, string) The Access Token Secret retrieved during the OAuth process.
     * @return Dropbox_Datastore_ListDatastores_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AccessToken input for this ListDatastores Choreo.
     *
     * @param string $value (required, string) The Access Token retrieved during the OAuth process.
     * @return Dropbox_Datastore_ListDatastores_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this ListDatastores Choreo.
     *
     * @param string $value (required, string) The App Key provided by Dropbox (AKA the OAuth Consumer Key).
     * @return Dropbox_Datastore_ListDatastores_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppSecret input for this ListDatastores Choreo.
     *
     * @param string $value (required, string) The App Secret provided by Dropbox (AKA the OAuth Consumer Secret).
     * @return Dropbox_Datastore_ListDatastores_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this ListDatastores Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.
     * @return Dropbox_Datastore_ListDatastores_Inputs For method chaining.
     */
...
/**
 * Execution object for the ListDatastores Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_ListDatastores_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the ListDatastores Choreo.
     *
     * @param Temboo_Session $session The session that owns this ListDatastores execution.
     * @param Dropbox_Datastore_ListDatastores $choreo The choreography object for this execution.
     * @param Dropbox_Datastore_ListDatastores_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_ListDatastores_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_ListDatastores_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Dropbox_Datastore_ListDatastores $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this ListDatastores execution.
     *
     * @return Dropbox_Datastore_ListDatastores_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this ListDatastores execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Dropbox_Datastore_ListDatastores_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Dropbox_Datastore_ListDatastores_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the ListDatastores Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_ListDatastores_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the ListDatastores Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Dropbox_Datastore_ListDatastores_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this ListDatastores execution.
     *
     * @return string The response from Dropbox. Corresponds to the ResponseFormat input. Defaults to json.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
 ...
 * @subpackage Dropbox
 */
class Dropbox_Datastore_PutDelta extends Temboo_Choreography
{
    /**
     * Writes a delta to the server, if the client is up to date.
     *
     * @param Temboo_Session $session The session that owns this PutDelta Choreo.
     * @return Dropbox_Datastore_PutDelta New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Dropbox/Datastore/PutDelta/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this PutDelta Choreo.
     *
     * @param Dropbox_Datastore_PutDelta_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_PutDelta_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_PutDelta_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Dropbox_Datastore_PutDelta_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this PutDelta Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_PutDelta_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Dropbox_Datastore_PutDelta_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the PutDelta Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_PutDelta_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the PutDelta Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Dropbox_Datastore_PutDelta_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this PutDelta input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the AccessTokenSecret input for this PutDelta Choreo.
     *
     * @param string $value (required, string) The Access Token Secret retrieved during the OAuth process.
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AccessToken input for this PutDelta Choreo.
     *
     * @param string $value (required, string) The Access Token retrieved during the OAuth process.
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppKey input for this PutDelta Choreo.
     *
     * @param string $value (required, string) The App Key provided by Dropbox (AKA the OAuth Consumer Key).
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AppSecret input for this PutDelta Choreo.
     *
     * @param string $value (required, string) The App Secret provided by Dropbox (AKA the OAuth Consumer Secret).
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Changes input for this PutDelta Choreo.
     *
     * @param string $value (required, json) A JSON-encoded list of changes. See Choreo notes for formatting details.
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
    public function setChanges($value)
    {
        return $this->set('Changes', $value);
    }

    /**
     * Set the value for the Handle input for this PutDelta Choreo.
     *
     * @param string $value (required, string) The handle of an existing datastore.
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Nonce input for this PutDelta Choreo.
     *
     * @param string $value (optional, string) An optional dbase64 string (up to 100 characters) used to uniquely identify this delta. If set to "default" a nonce will be auto-generated.
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
    public function setNonce($value)
    {
        return $this->set('Nonce', $value);
    }

    /**
     * Set the value for the ResponseFormat input for this PutDelta Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Revision input for this PutDelta Choreo.
     *
     * @param string $value (required, string) The revision from which to start.
     * @return Dropbox_Datastore_PutDelta_Inputs For method chaining.
     */
...
/**
 * Execution object for the PutDelta Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_PutDelta_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the PutDelta Choreo.
     *
     * @param Temboo_Session $session The session that owns this PutDelta execution.
     * @param Dropbox_Datastore_PutDelta $choreo The choreography object for this execution.
     * @param Dropbox_Datastore_PutDelta_Inputs|array $inputs (optional) Inputs as Dropbox_Datastore_PutDelta_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Dropbox_Datastore_PutDelta_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Dropbox_Datastore_PutDelta $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this PutDelta execution.
     *
     * @return Dropbox_Datastore_PutDelta_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this PutDelta execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Dropbox_Datastore_PutDelta_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Dropbox_Datastore_PutDelta_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the PutDelta Choreo.
 *
 * @package Temboo
 * @subpackage Dropbox
 */
class Dropbox_Datastore_PutDelta_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the PutDelta Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Dropbox_Datastore_PutDelta_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this PutDelta execution.
     *
     * @return string The response from Dropbox. Corresponds to the ResponseFormat input. Defaults to json.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
