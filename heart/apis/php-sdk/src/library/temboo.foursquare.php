 ...
 * @subpackage Foursquare
 */
class Foursquare_Users_LatestCheckinForUser extends Temboo_Choreography
{
    /**
     * Retrieves the latest check-in for an authenticated user.
     *
     * @param Temboo_Session $session The session that owns this LatestCheckinForUser Choreo.
     * @return Foursquare_Users_LatestCheckinForUser New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Foursquare/Users/LatestCheckinForUser/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this LatestCheckinForUser Choreo.
     *
     * @param Foursquare_Users_LatestCheckinForUser_Inputs|array $inputs (optional) Inputs as Foursquare_Users_LatestCheckinForUser_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Foursquare_Users_LatestCheckinForUser_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Foursquare_Users_LatestCheckinForUser_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this LatestCheckinForUser Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Foursquare_Users_LatestCheckinForUser_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Foursquare_Users_LatestCheckinForUser_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the LatestCheckinForUser Choreo.
 *
 * @package Temboo
 * @subpackage Foursquare
 */
class Foursquare_Users_LatestCheckinForUser_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the LatestCheckinForUser Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Foursquare_Users_LatestCheckinForUser_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this LatestCheckinForUser input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Foursquare_Users_LatestCheckinForUser_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the OauthToken input for this LatestCheckinForUser Choreo.
     *
     * @param string $value (required, string) The Foursquare API Oauth token string.
     * @return Foursquare_Users_LatestCheckinForUser_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this LatestCheckinForUser Choreo.
     *
     * @param string $value (optional, string) The format that response should be in. Can be set to xml or json. Defaults to json.
     * @return Foursquare_Users_LatestCheckinForUser_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the UserID input for this LatestCheckinForUser Choreo.
     *
     * @param string $value (optional, string) Only 'self' is supported at this moment by the Foursquare API. Defaults to: self.
     * @return Foursquare_Users_LatestCheckinForUser_Inputs For method chaining.
     */
...
/**
 * Execution object for the LatestCheckinForUser Choreo.
 *
 * @package Temboo
 * @subpackage Foursquare
 */
class Foursquare_Users_LatestCheckinForUser_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the LatestCheckinForUser Choreo.
     *
     * @param Temboo_Session $session The session that owns this LatestCheckinForUser execution.
     * @param Foursquare_Users_LatestCheckinForUser $choreo The choreography object for this execution.
     * @param Foursquare_Users_LatestCheckinForUser_Inputs|array $inputs (optional) Inputs as Foursquare_Users_LatestCheckinForUser_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Foursquare_Users_LatestCheckinForUser_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Foursquare_Users_LatestCheckinForUser $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this LatestCheckinForUser execution.
     *
     * @return Foursquare_Users_LatestCheckinForUser_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this LatestCheckinForUser execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Foursquare_Users_LatestCheckinForUser_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Foursquare_Users_LatestCheckinForUser_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the LatestCheckinForUser Choreo.
 *
 * @package Temboo
 * @subpackage Foursquare
 */
class Foursquare_Users_LatestCheckinForUser_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the LatestCheckinForUser Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Foursquare_Users_LatestCheckinForUser_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this LatestCheckinForUser execution.
     *
     * @return string The response from Foursquare. Corresponds to the ResponseFormat input. Defaults to JSON.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "City" output from this LatestCheckinForUser execution.
     *
    ...
    /**
     * Retrieve the value for the "CreatedAt" output from this LatestCheckinForUser execution.
     *
    ...
    /**
     * Retrieve the value for the "FormattedAddress" output from this LatestCheckinForUser execution.
     *
    ...
    /**
     * Retrieve the value for the "PostalCode" output from this LatestCheckinForUser execution.
     *
     * @return int (integer) The postal code of the venue.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
    ...
    /**
     * Retrieve the value for the "State" output from this LatestCheckinForUser execution.
     *
    ...
    /**
     * Retrieve the value for the "VenueID" output from this LatestCheckinForUser execution.
     *
    ...
    {
        return $this->get('VenueID');
    }
    /**
     * Retrieve the value for the "VenueName" output from this LatestCheckinForUser execution.
     *
