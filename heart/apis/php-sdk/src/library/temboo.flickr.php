 ...
 * @subpackage Flickr
 */
class Flickr_Photos_Replace extends Temboo_Choreography
{
    /**
     *  Replaces a photo that has already been uploaded to Flickr.
     *
     * @param Temboo_Session $session The session that owns this Replace Choreo.
     * @return Flickr_Photos_Replace New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Flickr/Photos/Replace/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this Replace Choreo.
     *
     * @param Flickr_Photos_Replace_Inputs|array $inputs (optional) Inputs as Flickr_Photos_Replace_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Flickr_Photos_Replace_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Flickr_Photos_Replace_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this Replace Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Flickr_Photos_Replace_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Flickr_Photos_Replace_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the Replace Choreo.
 *
 * @package Temboo
 * @subpackage Flickr
 */
class Flickr_Photos_Replace_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the Replace Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Flickr_Photos_Replace_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this Replace input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the ImageFileContents input for this Replace Choreo.
     *
     * @param string $value (conditional, string) The base-64 encoded file contents to replace. Required unless using the URL input.
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the APIKey input for this Replace Choreo.
     *
     * @param string $value (required, string) The API Key provided by Flickr (AKA the OAuth Consumer Key).
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the APISecret input for this Replace Choreo.
     *
     * @param string $value (required, string) The API Secret provided by Flickr (AKA the OAuth Consumer Secret).
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AccessTokenSecret input for this Replace Choreo.
     *
     * @param string $value (required, string) The Access Token Secret retrieved during the OAuth process.
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the AccessToken input for this Replace Choreo.
     *
     * @param string $value (required, string) The Access Token retrieved during the OAuth process.
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Async input for this Replace Choreo.
     *
     * @param bool $value (optional, boolean) Set to 1 to replace photos in async mode. This can be used if you don't want to wait around for an upload to complete.
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PhotoID input for this Replace Choreo.
     *
     * @param string $value (required, string) The ID of the photo to replace.
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    public function setPhotoID($value)
    {
    ...
    /**
     * Set the value for the ResponseFormat input for this Replace Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Valid values are: xml and json. Defaults to json.
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the URL input for this Replace Choreo.
     *
     * @param string $value (conditional, string) A url for a photo to use as the replacement. Required unless specifying the ImageFileContents.
     * @return Flickr_Photos_Replace_Inputs For method chaining.
     */
    public function setURL($value)
    {
...
/**
 * Execution object for the Replace Choreo.
 *
 * @package Temboo
 * @subpackage Flickr
 */
class Flickr_Photos_Replace_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the Replace Choreo.
     *
     * @param Temboo_Session $session The session that owns this Replace execution.
     * @param Flickr_Photos_Replace $choreo The choreography object for this execution.
     * @param Flickr_Photos_Replace_Inputs|array $inputs (optional) Inputs as Flickr_Photos_Replace_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Flickr_Photos_Replace_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Flickr_Photos_Replace $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this Replace execution.
     *
     * @return Flickr_Photos_Replace_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this Replace execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Flickr_Photos_Replace_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Flickr_Photos_Replace_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the Replace Choreo.
 *
 * @package Temboo
 * @subpackage Flickr
 */
class Flickr_Photos_Replace_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the Replace Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Flickr_Photos_Replace_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this Replace execution.
     *
     * @return string The response from Flickr.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
